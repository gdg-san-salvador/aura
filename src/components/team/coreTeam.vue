    ...
    <v-container class="pa-0">
        <v-layout wrap align-start justify-start row fill-height class="mt-0 mb-0">
            <v-flex xs12 class="mb-3">
                <p class="google-font" style="font-size:130%;">Nuestro Equipo</p>
                <v-divider></v-divider>
            </v-flex>
            <v-flex xs12 sm3 md2 lg2 v-for="(item,i) in TeamDetails" :key="i" class="text-xs-center" style="text-align:center">
