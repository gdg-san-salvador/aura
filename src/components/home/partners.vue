    ...
    <v-container class="pa-0 pb-5">
        <v-layout wrap align-center justify-center row fill-height>
            <v-flex xs12 md12>
                ...
                <p class="google-font mt-1 mb-0" style="font-size:120%">Un agradecimiento especial a todos nuestros patrocinadores por apoyar a nuestra comunidad.</p>
                <p class="google-font mt-0" style="font-size:120%">Si est&aacute;s interesado en patrocinar a nuestra comunidad y aparecer listado en <b>{{chapterDetails.ChapterName}}</b>, cont&aacute;ctanos v&iacute;a <a style="color:#1565C0;text-decoration: none;" :href="`mailto:${chapterDetails.ChapterEmail}`">{{chapterDetails.ChapterEmail}}</a> para conocer sobre las diversas oportunidades de patrocinio.</p>
            </v-flex>

            <v-flex xs12 md12 class="mt-2">
                <p class="google-font my-2" style="font-size:110%">Patrocinadores Generales</p>
            ...
            <v-flex xs12 md12 class="mt-3">
                <p class="google-font my-2" style="font-size:110%">Patrocinador de Plantilla Web</p>
