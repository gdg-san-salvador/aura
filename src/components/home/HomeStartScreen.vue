        ...
        <v-layout wrap align-center justify-center row fill-height >
           <v-flex xs12 sm5 md3 lg3 xl3 class="text-xs-center pa-3">
            ...
            <v-flex xs12 sm7 md8 lg8 xl8 class="">
                <p class="google-font mb-1" style="font-weight: 350;color: #616161;font-size:300%"><b>Caminando <span style="color: #1a73e8;">juntos</span> hacia el <span style="color: #1a73e8;">futuro</span>.</b>
                </p>
